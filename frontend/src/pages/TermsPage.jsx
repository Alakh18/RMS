      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="hidden lg:block lg:w-64 flex-shrink-0 lg:-ml-8">
            <div className="sticky top-24 glass-panel p-6 rounded-2xl border border-white/40 shadow-lg">
          ...
          <div className="flex-1 max-w-4xl">
            <div className="glass-panel p-8 md:p-12 rounded-3xl border border-white/40 shadow-xl relative overflow-hidden">
              ...
              {/* Introduction */}
              <div className="mb-12 p-6 bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl border border-primary/20">
              ...
              <div className="space-y-10">
                ...
                <section id="definitions" className="scroll-mt-24">
                  ...
                  <div className="ml-13 space-y-3 text-slate-600 leading-relaxed">
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-primary">
                      <strong className="text-slate-900">Platform:</strong> The RentalEco website, mobile applications, and all related backend systems and services.
                    </div>
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-primary">
                      <strong className="text-slate-900">Customer/Renter:</strong> Any individual or entity who registers on the platform to rent equipment, furniture, electronics, or other assets.
                    </div>
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-primary">
                      <strong className="text-slate-900">Vendor:</strong> A business or individual who lists products for rent on the platform.
                    </div>
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-primary">
                      <strong className="text-slate-900">Product:</strong> Electronics, furniture, vehicles, tools, or any other items listed for rental on the platform.
                    </div>
                    <div className="p-4 bg-slate-50 rounded-lg border-l-4 border-primary">
                      <strong className="text-slate-900">Rental Period:</strong> The agreed-upon duration for which a product is rented (Hourly, Daily, Weekly, or Custom periods).
                    </div>
                  </div>
                </section>
                ...
                <section id="registration" className="scroll-mt-24">
                  ...
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    <p>To use RentalEco, you must create an account and provide the following:</p>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>You must be at least <strong className="text-slate-900">18 years old</strong> to register and use this platform.</li>
                      <li>You agree to provide <strong className="text-slate-900">accurate, current, and complete information</strong> during registration.</li>
                      <li>Vendors must provide a valid <strong className="text-slate-900">GSTIN</strong> (Goods and Services Tax Identification Number).</li>
                ...
                <section id="rental" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Rental Process & Orders</h2>
                  </div>
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="p-5 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                        <h3 className="font-bold text-blue-900 mb-2">📋 Quotations</h3>
                        <p className="text-sm text-blue-800">Quotations are non-binding estimates. Final pricing is confirmed upon order placement.</p>
                      </div>
                      <div className="p-5 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
                        <h3 className="font-bold text-green-900 mb-2">✅ Order Confirmation</h3>
                        <p className="text-sm text-green-800">Once confirmed, an order creates a binding reservation between you and the vendor.</p>
                      </div>
                    </div>
                    <ul className="list-disc list-inside space-y-2 ml-4 mt-4">
                      <li>All orders are subject to <strong className="text-slate-900">product availability</strong>.</li>
                      <li>First-time renters may be required to provide <strong className="text-slate-900">ID verification</strong> (Aadhaar, PAN, or Driver's License).</li>
                ...
                <section id="pricing" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Pricing, Payments, and Taxes</h2>
                  </div>
                  <div className="ml-13 space-y-4">
                    <div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                      <h3 className="font-bold text-purple-900 mb-3">💰 Payment Structure</h3>
                ...
                <section id="pickup" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Pickup and Delivery</h2>
                  </div>
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    ...
                    <p className="mt-4">
                      <strong className="text-slate-900">Important:</strong> It is the renter's responsibility to inspect the product at pickup. 
                ...
                <section id="returns" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Returns and Late Fees</h2>
                  </div>
                  <div className="ml-13 space-y-4">
                    ...
                    <div className="p-6 bg-red-50 rounded-xl border-2 border-red-300">
                      <h3 className="font-bold text-red-900 mb-3 text-lg">⏰ Late Fee Policy</h3>
                    ...
                    <div className="space-y-3 text-slate-600">
                      <p><strong className="text-slate-900">Return Condition Requirements:</strong></p>
                      <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <section id="cancellations" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Cancellations and Refunds</h2>
                  </div>
                  <div className="ml-13 space-y-4">
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="p-5 bg-green-50 rounded-xl border-2 border-green-300 text-center">
                        <div className="text-3xl mb-2">✅</div>
                        <h3 className="font-bold text-green-900 mb-2">24+ Hours Before</h3>
                        <p className="text-sm text-green-800">Full refund</p>
                        <p className="text-xs text-green-700 mt-1">(100% refund)</p>
                      </div>
                      <div className="p-5 bg-yellow-50 rounded-xl border-2 border-yellow-300 text-center">
                        <div className="text-3xl mb-2">⚠️</div>
                        <h3 className="font-bold text-yellow-900 mb-2">12-24 Hours Before</h3>
                        <p className="text-sm text-yellow-800">50% cancellation fee</p>
                        <p className="text-xs text-yellow-700 mt-1">(50% refund)</p>
                      </div>
                      <div className="p-5 bg-red-50 rounded-xl border-2 border-red-300 text-center">
                        <div className="text-3xl mb-2">❌</div>
                        <h3 className="font-bold text-red-900 mb-2">Less than 12 Hours</h3>
                        <p className="text-sm text-red-800">No refund</p>
                        <p className="text-xs text-red-700 mt-1">(0% refund)</p>
                      </div>
                    </div>
                ...
                <section id="liability" className="scroll-mt-24">
                  ...
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    <div className="p-6 bg-amber-50 rounded-xl border border-amber-300">
                      <p className="mb-3">
                        <strong className="text-slate-900">RentalEco Pvt. Ltd.</strong> operates as a <strong className="text-slate-900">marketplace facilitator</strong> 
                        and acts as an intermediary between vendors and customers.
                      </p>
                      <p className="font-semibold text-amber-900">We are NOT liable for:</p>
                ...
                <section id="privacy" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Privacy and Data Protection</h2>
                  </div>
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    <p>
                    ...
                    <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
                      <h3 className="font-bold text-slate-900 mb-3">🔒 Data We Collect:</h3>
                ...
                <section id="disputes" className="scroll-mt-24">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">Dispute Resolution and Governing Law</h2>
                  </div>
                  <div className="ml-13 space-y-4 text-slate-600 leading-relaxed">
                    <p>
                      These Terms and Conditions are governed by the laws of <strong className="text-slate-900">India</strong>. 
                    ...
                    <div className="space-y-3 mt-4">
                      <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg">
                        ...
                        <div>
                          <h4 className="font-semibold text-slate-900">Negotiation</h4>
                      ...
                      <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg">
                        ...
                        <div>
                          <h4 className="font-semibold text-slate-900">Mediation</h4>
                      ...
                      <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg">
                        ...
                        <div>
                          <h4 className="font-semibold text-slate-900">Arbitration/Legal Action</h4>
                ...
                <section className="scroll-mt-24">
                  <div className="p-6 bg-gradient-to-r from-slate-50 to-slate-100 rounded-2xl border border-slate-200">
                    <h3 className="font-bold text-slate-900 mb-4 text-lg">📜 Additional Terms</h3>
              ...
              {/* Contact Section */}
              <div className="mt-12 p-8 bg-gradient-to-br from-primary/10 via-purple-50 to-accent/10 rounded-2xl border-2 border-primary/30 shadow-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-white rounded-xl border border-slate-200 md:col-span-2">
                ...
                <div className="mt-6 p-4 bg-white rounded-xl border border-primary/30">
