  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-slate-900 text-[#0d131c] dark:text-slate-100 font-display antialiased">
      ...
      <section className="relative pt-32 pb-12 px-6 hero-gradient dark:bg-slate-900 overflow-hidden">
        <div className="absolute top-1/4 left-10 w-64 h-64 bg-primary/10 dark:bg-primary/20 rounded-full blur-3xl -z-10 animate-pulse"></div>
        <div className="absolute bottom-1/4 right-10 w-80 h-80 bg-accent/10 dark:bg-accent/20 rounded-full blur-3xl -z-10"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mt-10">
            <div className="glass-panel dark:bg-slate-800 p-5 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 rounded-lg">
                  <span className="material-symbols-outlined text-primary text-[20px]">list_alt</span>
                </div>
                <div>
                  <p className="text-2xl font-black text-slate-900 dark:text-slate-100">{stats.total}</p>
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">Total Orders</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel dark:bg-slate-800 p-5 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-2xl font-black text-slate-900 dark:text-slate-100">{stats.confirmed}</p>
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">Confirmed</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel dark:bg-slate-800 p-5 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 rounded-lg">
                  <span className="material-symbols-outlined text-blue-600 dark:text-blue-400 text-[20px]">autorenew</span>
                </div>
                <div>
                  <p className="text-2xl font-black text-slate-900 dark:text-slate-100">{stats.active}</p>
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">Active</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel dark:bg-slate-800 p-5 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-600 rounded-lg">
                  <span className="material-symbols-outlined text-slate-600 dark:text-slate-400 text-[20px]">task_alt</span>
                </div>
                <div>
                  <p className="text-2xl font-black text-slate-900 dark:text-slate-100">{stats.completed}</p>
                  <p className="text-xs text-slate-600 dark:text-slate-400 font-medium">Completed</p>
                </div>
              </div>
            </div>

            <div className="glass-panel dark:bg-slate-800 p-5 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg hover:shadow-xl transition-all col-span-2 md:col-span-3 lg:col-span-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-2xl font-black text-slate-900 dark:text-slate-100">₹{stats.totalSpent.toLocaleString()}</p>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 space-y-4">
            {/* Search Bar */}
            <div className="glass-panel dark:bg-slate-800 p-4 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:border-primary transition-colors"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 hover:bg-slate-100 dark:hover:bg-slate-600 rounded-lg transition-colors"
                  >
                    <span className="material-symbols-outlined text-slate-400 dark:text-slate-500 text-[20px]">close</span>
                  </button>
                )}
              </div>
            </div>
            ...
            {/* Filter Tabs */}
            <div className="glass-panel dark:bg-slate-800 p-2 rounded-2xl border border-white/40 dark:border-slate-700 shadow-lg overflow-x-auto">
          ...
          {loading ? (
            <div className="space-y-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="glass-panel dark:bg-slate-800 h-64 rounded-3xl animate-pulse border border-white/40 dark:border-slate-700"></div>
              ))}
            </div>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {(searchQuery || activeFilter !== 'all') && (
                  <button
                    ...
                    className="px-8 py-4 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-600 hover:border-primary transition-all"
                  >
                    Clear Filters
                  </button>
                )}
            ...
            <div className="space-y-6">
              {filteredOrders.map((order) => (
                <div key={order.id} className="glass-panel dark:bg-slate-800 rounded-3xl border border-white/40 dark:border-slate-700 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
                  
                  {/* Order Header */}
                  <div className="px-6 py-5 bg-gradient-to-r from-slate-50/50 to-slate-100/50 dark:from-slate-900/50 dark:to-slate-800/50 border-b border-slate-200 dark:border-slate-700 flex flex-wrap gap-4 items-center justify-between">
                    <div className="flex flex-wrap gap-6 text-sm">
                      <div>
                        <p className="text-slate-500 dark:text-slate-400 mb-1 font-medium flex items-center gap-1">
                          <span className="material-symbols-outlined text-[16px]">calendar_today</span>
                          Order Placed
                        </p>
                        <p className="font-bold text-slate-900 dark:text-slate-100">{new Date(order.date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                      </div>
                      <div>
                        <p className="text-slate-500 dark:text-slate-400 mb-1 font-medium flex items-center gap-1">
                      ...
                      <div>
                        ...
                        <p className="font-mono text-slate-900 dark:text-slate-100 font-bold">#{order.id}</p>
                      </div>
                    </div>
                  ...
                  <div className="p-6 space-y-6">
                    {order.items.map((item, idx) => (
                      <div key={idx} className="flex flex-col md:flex-row gap-6 p-5 bg-white dark:bg-slate-700 rounded-2xl border border-slate-200 dark:border-slate-600 hover:border-primary/30 transition-all group/item">
                        
                        {/* Image */}
                        <Link 
                          to={`/product/${item.product.id}`}
                          className="relative w-full md:w-32 h-48 md:h-32 bg-slate-100 dark:bg-slate-600 rounded-xl overflow-hidden border-2 border-slate-200 dark:border-slate-600 shrink-0 group-hover/item:border-primary transition-all"
                        >
                          <img 
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-4 mb-3">
                            <div className="flex-1">
                              ...
                              >
                                <h3 className="text-xl font-black text-slate-900 dark:text-slate-100 mb-1 line-clamp-2">{item.product.name}</h3>
                              </Link>
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button 
                              ...
                              className="px-5 py-2.5 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 text-sm font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-primary transition-all flex items-center gap-2"
                            >
                              <span className="material-symbols-outlined text-[18px]">description</span>
                              View Invoice
                            </button>
                            <button className="px-5 py-2.5 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 text-sm font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-primary transition-all flex items-center gap-2">
                              <span className="material-symbols-outlined text-[18px]">support_agent</span>
                              Get Help
                            </button>
                            <button className="px-5 py-2.5 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 text-sm font-bold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-red-500 hover:text-red-500 transition-all flex items-center gap-2">
                  ...
                  <div className="px-6 py-5 bg-gradient-to-r from-slate-50/50 to-slate-100/50 dark:from-slate-900/50 dark:to-slate-800/50 border-t border-slate-200 dark:border-slate-700">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-sm">
                        <span className="material-symbols-outlined text-green-600 dark:text-green-400 text-[20px] filled">local_shipping</span>
                        <span className="font-semibold text-slate-700 dark:text-slate-300">
                          {order.status === 'completed' ? 'Delivered Successfully' : 'Estimated Delivery: In Progress'}
                        </span>
                      </div>
                      <button className="px-4 py-2 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 text-primary dark:text-blue-400 text-sm font-bold rounded-xl hover:bg-primary hover:text-white hover:border-primary transition-all flex items-center gap-2">
