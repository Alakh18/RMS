    ...
    <div className="min-h-screen bg-background-light text-[#0d131c] font-display antialiased">
      ...
      <section className="relative pt-32 pb-24 px-6 hero-gradient flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto z-10">
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in-up delay-200">
            Building a sustainable, shared economy where <span className="font-bold text-slate-900">access beats ownership</span>. 
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 animate-fade-in-up delay-300">
            <Link to="/products" className="px-8 py-4 bg-primary hover:bg-primary-dark text-white font-bold rounded-xl shadow-lg hover:shadow-primary/40 transition-all transform hover:scale-105 flex items-center gap-2">
              Explore Products
              <span className="text-xl">→</span>
            </Link>
            <Link to="/vendor-signup" className="px-8 py-4 bg-white border-2 border-slate-300 text-slate-700 font-bold rounded-xl hover:bg-slate-50 transition-all transform hover:scale-105">
              List Your Products
            </Link>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  RentalEco was born in <strong className="text-slate-900">2024</strong> when our founder, Priya Sharma, 
                  struggled to find affordable camera equipment for a short film project. She realized that thousands 
                  of people faced the same problem—<strong className="text-slate-900">needing expensive equipment for short periods</strong>.
                </p>
                <p>
                  What started as a simple idea quickly evolved into a mission: <strong className="text-slate-900">make premium 
              ...
              <div className="mt-8 flex gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-slate-500 font-semibold">Years Active</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-black text-primary">5</p>
                  <p className="text-sm text-slate-500 font-semibold">Cities Covered</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-black text-primary">15k+</p>
                  <p className="text-sm text-slate-500 font-semibold">Rentals Completed</p>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="glass-panel p-8 rounded-3xl border border-white/50 shadow-2xl relative overflow-hidden">
              ...
              {/* Floating Stats */}
              <div className="absolute -top-6 -left-6 glass-panel p-4 rounded-2xl shadow-xl border border-white/50 animate-float">
                <p className="text-2xl font-black text-primary">10k+</p>
                <p className="text-xs text-slate-600 font-semibold">Happy Users</p>
              </div>
              <div className="absolute -bottom-6 -right-6 glass-panel p-4 rounded-2xl shadow-xl border border-white/50 animate-float delay-500">
                <p className="text-2xl font-black text-accent">99%</p>
                <p className="text-xs text-slate-600 font-semibold">Satisfaction</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">Guided by purpose, driven by innovation</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="glass-panel p-10 md:p-12 rounded-3xl border border-white/50 relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              <div className="absolute top-0 right-0 w-48 h-48 bg-blue-50 rounded-full blur-3xl -z-10 group-hover:bg-blue-100 transition-colors"></div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                To <strong className="text-slate-900">democratize access to premium assets</strong>. We believe that everyone 
            ...
            {/* Vision Card */}
            <div className="glass-panel p-10 md:p-12 rounded-3xl border border-white/50 relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              <div className="absolute top-0 right-0 w-48 h-48 bg-purple-50 rounded-full blur-3xl -z-10 group-hover:bg-purple-100 transition-colors"></div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                To become the <strong className="text-slate-900">world's most trusted rental ecosystem</strong>, reducing 
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">Key milestones that shaped RentalEco</p>
          </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={index} className={`flex flex-col md:flex-row items-center gap-8 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="glass-panel p-6 rounded-2xl border border-white/50 shadow-lg hover:shadow-xl transition-all">
                  ...
                  <div className="hidden md:flex w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-black text-xl shadow-lg z-10 border-4 border-white">
                    {index + 1}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="group">
                <div className="glass-panel p-6 rounded-3xl border border-white/50 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 mb-4">Why Choose RentalEco?</h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-green-50 hover:to-emerald-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-green-200 group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Sustainable Choice</h3>
            ...
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-blue-200 group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Verified Trust</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-amber-50 hover:to-orange-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-amber-200 group">
            ...
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-purple-50 hover:to-pink-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-purple-200 group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Cost Effective</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-red-50 hover:to-rose-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-red-200 group">
            ...
            <div className="p-8 rounded-3xl bg-white hover:bg-gradient-to-br hover:from-teal-50 hover:to-cyan-50 hover:shadow-2xl transition-all duration-300 border-2 border-slate-100 hover:border-teal-200 group">
      ...
      <section className="py-20 px-6 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative z-10 glass-panel rounded-[3rem] p-8 md:p-16 border-2 border-white/50 shadow-2xl overflow-hidden">
            {/* Gradient Overlay */}
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-slate-600 mb-10 max-w-3xl mx-auto leading-relaxed">
                Join <strong className="text-slate-900">10,000+ smart renters</strong> who are saving money and helping the planet. 
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-12">
                ...
                <Link to="/vendor-signup" className="px-10 py-5 bg-white border-3 border-slate-300 text-slate-700 font-black text-lg rounded-2xl hover:bg-slate-50 hover:border-primary transition-all transform hover:scale-105 hover:-translate-y-1 shadow-lg">
                  Become a Vendor
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-100 hover:border-blue-300 transition-all group">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">Instant Booking</h3>
                  <p className="text-sm text-slate-600">Book in seconds and get instant confirmation</p>
                </div>
                
                <div className="p-6 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-100 hover:border-green-300 transition-all group">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">Secure Payments</h3>
                  <p className="text-sm text-slate-600">Bank-grade encryption for all transactions</p>
                </div>
                
                <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-100 hover:border-purple-300 transition-all group">
                  ...
                  <h3 className="font-bold text-slate-900 mb-2 text-lg">Verified Products</h3>
                  <p className="text-sm text-slate-600">Every item inspected and quality guaranteed</p>
                </div>
              </div>
