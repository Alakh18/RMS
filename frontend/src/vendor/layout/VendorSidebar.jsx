...
const VendorSidebar = ({ isOpen, onToggle }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed lg:static top-0 left-0 z-50 h-screen w-64 bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700
      ...
      >
        ...
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-slate-900 dark:text-slate-100">RentalPro</h3>
